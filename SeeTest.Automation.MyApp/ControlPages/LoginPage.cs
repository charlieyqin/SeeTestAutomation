...
namespace SeeTest.Automation.EriBankTests.ControlPages
{
    public static class LoginPage
    {
        ...
        {
            return new Control("Native", "xpath=//*[@accessibilityIdentifier='usernameTextField']", "UserName", "", "Textbox");
        }

        public static Control PasswordTextbox()
        {
            return new Control("Native", "xpath=//*[@accessibilityIdentifier='passwordTextField']", "Password", "", "Textbox");
        }
